...
const RATE_OVERRIDES: Record<string, Partial<CityRate>> = {
  "new-york": {
    ...
    // TLC yellow: $3.00 + $3.50/mi + $0.70/min slow — used when productRates falls through
    taxi: { base: 3.0, perMile: 3.5, perMin: 0.7, booking: 0, minimum: 3.0 },
    // RideWise NYC typical surge table (UberX)
    surge: { morning: 1.3, evening: 1.4, late: 1.2 },
  },
  "san-francisco": {
